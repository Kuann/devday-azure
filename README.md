...
By default, database servers created are not accessible for other services and the Internet so you need to find way to re-config it's firewall to open access.
...
When your application is on cloud. Monitoring is much more easier.
